            ...
            <?php echo form_open('user_history_pelayanan/add'); ?>
          	<div class="box-body">
          		<div class="row clearfix">
					<div class="col-md-6">
						<label for="user_id" class="control-label">Nama Pendaftar - No Pendaftaran</label>
						<div class="form-group">
							<select name="user_id" class="form-control">
								...
								foreach($all_mstunit as $user_aplikasi)
								{
									...
									echo '<option value="'.$user_aplikasi['user_id'].'" '.$selected.'>'.$user_aplikasi['full_name'].' - '.$user_aplikasi['no_pendaftaran'].'</option>';
								} 
								?>
							</select>
						</div>
