    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Upload Laporan Bulanan</h3><br/>
              	<?php
			...
			<?php echo form_open_multipart('indikatorbulanan/edit/'.$image_banner['id_laporan']); ?>
			<div class="box-body">
				<div class="row clearfix">
					<div class="col-md-6">
						<label for="end_date" class="control-label">Nama File</label>
						<div class="form-group">
							<input type="text" name="nama_file" value="<?php echo ($this->input->post('nama_file') ? $this->input->post('nama_file') : $image_banner['nama_file']); ?>" class=" form-control"   />
						</div>
					</div>
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="file" onChange="return validate_video(this,'add')" name="userfile" class="form-control" id="file" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="tahun" class="form-control">
								...
								<?php 
								for($a = date('Y', strtotime('-2 years')); $a <= date('Y', strtotime('+5 years')); $a++)
								{
									$selected = ($a == $image_banner['tahun']) ? ' selected="selected"' : "";
							...
							<br/>laporan saat ini : <a href="<?php echo $image_banner['link'];?>">Download</a>
						</div>
					</div>
