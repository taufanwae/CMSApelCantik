    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Alat Kontrasepsi Edit</h3>
            </div>
			<?php echo form_open('stok_alat_kontrasepsi/edit/'.$alat_kontrasepsi['stok_id']); ?>
			<div class="box-body">
				<div class="row clearfix">
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="tipekb_id" class="form-control">
								...
								{
									$selected = ($jenis_kb['tipekb_id'] == $alat_kontrasepsi['tipekb_id']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="jml_stok" value="<?php echo ($this->input->post('jml_stok') ? $this->input->post('jml_stok') : $alat_kontrasepsi['jml_stok']); ?>" class="form-control" id="jml_stok" />
