            ...
            <div class="box-body">
                <table class="table table-striped" id="exampleButtonExport">
                    ...
                    <tr>
						...
						<td>
                           <?php if(in_array($r['status_pendaftaran'],array('3','4'))) 
                           {
                                ?>
                           ...
                           {
                                 ?>
                                     <a href="<?php echo site_url('reg_pelayanan/edit/'.$r['id_reg_pelayanan']); ?>" class="btn btn-info btn-xs"><span class="fa fa-pencil"></span> Detail - Ubah Status</a> 
                                <?php
                           }
