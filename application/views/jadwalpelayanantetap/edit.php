			...
			<div class="box-body">
				<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text"  autocomplete="off" name="tanggal" id="datepicker" value="<?php echo ($this->input->post('tanggal') ? $this->input->post('tanggal') : $info_jadwal_pelayanan_tetap['tanggal']); ?>" class="form-control"  />
