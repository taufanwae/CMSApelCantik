            ...
            <?php echo form_open('jadwalpelayanantetap/add'); ?>
          	<div class="box-body">
          		<div class="row clearfix">
          			...
          			<?php 
								$hidden = $this->session->userdata('lokasipelayanan_id') != "0" ? "style='display:none;'" : "";
							 ?>
						...
						<div class="form-group">
							...
							<select name="lokasipelayanan_id" class="form-control">
								...
								foreach($all_mstlokasipelayanan as $lokasi_pelayanan)
								{
									...
									if($this->session->userdata('lokasipelayanan_id') != "0")
									{
										if($this->session->userdata('lokasipelayanan_id') == $lokasi_pelayanan['lokasipelayanan_id'])
										{
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" autocomplete="off" name="tanggal" id="datepicker" placeholder="Misal : 2021-06-01" value="<?php echo $this->input->post('tanggal'); ?>" class=" form-control"  />
