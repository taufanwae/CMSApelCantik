    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Ubah Data Jumlah Kartu Keluarga</h3>
            </div>
			<?php echo form_open('datakartukeluarga/edit/'.$desa['idjumlahkk']); ?>
			<div class="box-body">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="kecamatan_id" class="form-control">
								...
								{
									$selected = ($kecamatan['kecamatan_id'] == $desa['kecamatan_id']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="idperiode" class="form-control">
								...
								{
									$selected = ($periode['idperiode'] == $desa['idperiode']) ? ' selected="selected"' : "";
				...
				<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="number" required name="jml_lakilaki" value="<?php echo ($this->input->post('jml_lakilaki') ? $this->input->post('jml_lakilaki') : $desa['jml_lakilaki']); ?>" class="form-control" id="jml_lakilaki" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="number" required name="jml_perempuan" value="<?php echo ($this->input->post('jml_perempuan') ? $this->input->post('jml_perempuan') : $desa['jml_perempuan']); ?>" class="form-control" id="jml_perempuan" />
