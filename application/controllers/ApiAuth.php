...
class ApiAuth extends CI_Controller{
    ...
    function VerifyRegisterUser()
    {
        ...
        $token_fcm           = secure_input($this->input->post('token_fcm'));
        $pin = md5($pin);
        ...
        }else 
        {
            ...
            $this->model->updateData('mstuser', array('token_login' => $tokenLogin, 'token_fcm' => $token_fcm), array('no_ktp' => $noKtp));
     ...
     function login()
    {
       ...
       if($checkNoKtp->num_rows() < 1)
        ...
        }else 
        {
            ...
            $update = $this->model->updateData('mstuser',array('token_fcm'=>$token_fcm),$where);
