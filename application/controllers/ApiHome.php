...
class ApiHome extends CI_Controller{
    ...
    function daftarLayananKB()
    {
        ...
        }else 
        {
            ...
            $dataInsert = array(
                ...
                ,'no_pendaftaran' => $user_id.strtotime(date('YmdHis'))
            );
    ...
    function dataStatusDaftar()
    {
        ...
        }else 
        {
            ...
            $tglDaftar = $dataReg['register_date'] == "" ? "" : $this->tanggalIndo(date('Y-m-d',strtotime($dataReg['register_date'])));
            $statusDaftar = $dataReg['status_pendaftaran'];
            $noPendaftaran = $dataReg['no_pendaftaran'];

            switch ($statusDaftar) {
                case '1': $statusDaftar = "Pending"; break;
                case '2': $statusDaftar = "Diproses"; break;
                case '3': $statusDaftar = "Diterima"; break;
    ...
    function getDataIndikator()
    {
        ...
        {
            $dataReg = $this->model->getDataIndikator($tipe);
            $arrData = array();
            foreach ($dataReg->result_array() as $key) {

                $var['id']    = $key['data_id'];
                $var['tipe']    = $key['tipe'];
                $var['link']         = site_url()."upload/file/".$key['link_file'];
                $var['periode'] = $key['periode'];
                $var['nama_file'] = $key['nama_file'];
    ...
    function getDataPerpustakaan()
    {
        ...
        {
            $dataReg = $this->model->getDataPerpustakaan();
            $arrData = array();
            foreach ($dataReg->result_array() as $key) {

                $var['id']    = $key['slider_id'];
                $var['link']         =  $key['slider_url'];
                $var['judul'] = $key['judul'];
                $var['nama_file'] = $key['slider_file_name'];
    ...
    function getListKonten()
    {
        ...
        {
            $dataReg = $this->model->getListKonten();
            $arrData = array();
            foreach ($dataReg->result_array() as $key) {
