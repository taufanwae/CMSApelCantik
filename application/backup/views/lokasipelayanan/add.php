    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Lokasi Pelayanan Add</h3>
            </div>
            <?php echo form_open('lokasipelayanan/add'); ?>
          	<div class="box-body">
          		<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="nama_lokasi" value="<?php echo $this->input->post('nama_lokasi'); ?>" class="form-control" id="nama_lokasi" />
							...
							<?php 
								foreach($all_tipekb as $tipekb)
								{
									...
									echo '<div class="checkbox">
											  <label><input type="checkbox" name="tipekb[]" value="'.$tipekb['tipekb_id'].'">'.$tipekb['nama_tipe'].'</label>
										</div>';
