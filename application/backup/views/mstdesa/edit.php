 <div class="row">
    <div class="col-md-12">
      	<div class="box box-info">
			...
			<?php echo form_open('mstdesa/edit/'.$desa['desa_id']); ?>
			<div class="box-body">
				<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="nama_desa" value="<?php echo ($this->input->post('nama_desa') ? $this->input->post('nama_desa') : $desa['nama_desa']); ?>" class="form-control" id="nama_desa" />
