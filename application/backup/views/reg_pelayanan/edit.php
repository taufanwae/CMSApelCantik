				...
				<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							...
							?>
							<input  readonly type="text" name="xyz" value="<?php echo $status; ?>" class="form-control" id="status_pendaftaran" />
						</div>
					</div>
						...
						<div class="form-group">
							<select name="status_pendaftaran" class="form-control">
								<?php 
									...
									<option value="2" '.$selected2.'>Diproses</option>
									<option value="3" '.$selected3.'>Selesai</option>
